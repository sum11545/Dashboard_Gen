...
Renders all KPIs and charts dynamically without hardcoding any values and Use Fetch Value to dynamically render the KPI and Chart value dont use sample data value.
